...
@section('main')
            ...
            <form class="my-3" method="post" action="/dashboard/items/{{ $item->id }}">
                @method('put')
                @csrf
                <div class="d-flex">
                    <div class="mb-3 flex-fill mx-2">
                        ...
                        <input type="text" class="form-control @error('nama_produk') is-invalid @enderror"
                            name="nama_produk" id="nama_produk" placeholder=""
                            value="{{ old('nama_produk', $item->nama_produk) }}" autofocus required>
                        @error('nama_produk')
                    ...
                    <div class="mb-3 flex-fill mx-2">
                        ...
                        <input type="text" class="form-control @error('value') is-invalid @enderror" name="value"
                            id="value" placeholder="" value="{{ old('value', $item->value) }}" required>
                        @error('value')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3 flex-fill mx-2">
                        ...
                        <input type="text" class="form-control @error('sound_quality') is-invalid @enderror"
                            name="sound_quality" id="sound_quality" placeholder=""
                            value="{{ old('sound_quality', $item->sound_quality) }}" required>
                        @error('sound_quality')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div>
                    ...
                    <div class="mb-3 mx-2">
                        ...
                        <input type="text" class="form-control @error('link') is-invalid @enderror" name="link"
                            id="link" placeholder="" value="{{ old('link', $item->link) }}" required>
                        @error('link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="d-flex">
                        <div class="mb-3 mx-2 flex-fill">
                            ...
                            <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga"
                                id="harga" placeholder="" value="{{ old('harga', $item->harga) }}" required>
                            @error('harga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-3 mx-2">
                        ...
                        <input type="text" class="form-control @error('img') is-invalid @enderror" name="img"
                            id="img" placeholder="" value="{{ old('img', $item->img) }}" required>
                        @error('img')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3 mx-2">
                        ...
                        <input id="review" type="hidden" name="review" class="reviewInputH"
                            value="{{ old('review', $item->review) }}">
                ...
                <div class="d-flex mx-2">
                    <button type="submit" class="btn primary-btn bg-warning" style="width: 100px;">Update</button>
